...
from datasetsio  import TrainDatasetFromFolder4, TrainDatasetFromFolder2,TestDatasetFromFolder1
...
# --- Load training data and validation/test data --- #
    ...
    train_loader1= DataLoader(TrainDatasetFromFolder2('./dataset/ITS/clear',
                                     './dataset/ITS/haze',
                                                      './dataset/realhaze',
                                                       crop_size=128), batch_size=1,shuffle=True)  # SIDMS   /home/omnisky/volume/ITSV2/clear
    #
    train_loader2 = DataLoader(TrainDatasetFromFolder4('./dataset/OTS/clear',
                                                    './dataset/OTS/haze',
                                                    './dataset/realhaze', crop_size=128), batch_size=1,shuffle=True )  #SIDMS   /home/omnisky/volume/ITSV2/clear
    #
    valid_loader = DataLoader(TestDatasetFromFolder1('./'),  # real test-rrrrrr
                                 batch_size=1, shuffle=False, num_workers=1)
    # Initialize model and train 
    dehamer = dehamer(params, trainable=True)
    dehamer.train(train_loader1,train_loader2, valid_loader)
